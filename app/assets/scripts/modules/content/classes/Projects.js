const Projects = {
	houseStocker: {
		...
		images: [
			"url('assets/images/projects/house-stocker.png')",
			"url('assets/images/projects/house-storage-1.png')",
			"url('assets/images/projects/house-storage-2.png')"
		],
		sampleCode: [
			{
				...
				photo: 'assets/images/projects/project-code-1.png'
			},
			{
				...
				photo: 'assets/images/projects/project-code-2.png'
			},
			{
				...
				photo: 'assets/images/projects/project-code-3.png'
			},
			{
				title: 'EJS view',
				description:
				...
				photo: 'assets/images/projects/project-code-4.png'
			}
		]
	}
};
